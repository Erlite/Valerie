...
namespace Valerie.Handlers.Config.Models
{
    public class ConfigModel
    {
        ...
        public List<string> EvalImports { get; set; } = new List<string>() { "System", "System.Collections.Generic", "System.Linq" };
        public List<string> BotGames { get; set; } = new List<string>() { "With You", "Tumblr" };
